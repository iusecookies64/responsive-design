...
export default function FormSmall() {
  ...
  return (
    <div
      ...
      style={{ fontWeight: 600, width: "312px", maxWidth: "434px" }}
    >
      <div
        className="d-flex flex-row gap-4 fs-3"
      ...
      {signin ? (
        <div className="d-flex flex-column gap-3">
          ...
          <div
            className="d-flex w-full bg-primary text-white rounded justify-content-center align-items-center"
            style={{ height: "32px" }}
          >
            Continue
          </div>
        ...
        <div className="d-flex flex-column gap-3">
          ...
          <div>
            <div
              className="d-flex flex-row w-full justify-content-center align-items-center fw-normal fs-7 text-secondary fw-medium"
              style={{ height: "32px" }}
            >
